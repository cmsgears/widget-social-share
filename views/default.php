<ul class="nav">
    <?php if( array_key_exists( 'facebook', $widget->links ) ) { ?>
       <li> <a title="Share on Facebook" class="share-facebook <?= $widget->iconSet ?>facebook color-facebook " href="http://www.facebook.com/sharer.php?u=<?= $widget->url ?>" target="_blank"" ></a></li>
    <?php } ?>
